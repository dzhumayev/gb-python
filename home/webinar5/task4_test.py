...
class Test(TestCase):
    def test_rele_compress(self):
        input = "Съешьььь ееееещё этииииииих мяягких фффранцузских булок, да выпей же чаю #1а"
        actual = task4.rle_compress(input)
        expected = "Съеш#4ь #5ещё эт#7их мяягких фффранцузских булок, да выпей же чаю #_1а"
